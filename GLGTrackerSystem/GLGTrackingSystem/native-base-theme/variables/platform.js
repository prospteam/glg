...
export default {
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#007aff' : '#03365c',
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#03365c',
  ...
  // tabBarActiveTextColor: platform === PLATFORM.IOS ? '#03365c' : '#fff',
  tabBarActiveTextColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  tabActiveBgColor: platform === PLATFORM.IOS ? '#03365c' : '#03365c',

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#03365c',
  ...
  toolbarDefaultBorder: platform === PLATFORM.IOS ? '#a7a6ab' : '#03365c',
  ...
  listItemSelected: platform === PLATFORM.IOS ? '#007aff' : '#03365c',
  ...
  radioSelectedColorAndroid: '#03365c',
  ...
  // Segment
  segmentBackgroundColor: platform === PLATFORM.IOS ? '#F8F8F8' : '#03365c',
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentTextColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : '#03365c',
  segmentBorderColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentBorderColorMain: platform === PLATFORM.IOS ? '#a7a6ab' : '#03365c',
  ...
  tabDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#03365c',
