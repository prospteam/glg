...
import { set_show_mini_loader, set_sampleString, set_is_logged } from '../../redux/actions/Actions';// I included ang
"index.js"
...
if (this.state.response.length <= 0) load_details=<Card>
    <CardItem header>
        <View>
    ...
    return (
    <Screen active_tab="Loads" title="My Loads" side_header_buttons={ <View
        style={{...styles.darkFont,flex:1,flexDirection:'row-reverse'}}>
        ...
        <ScrollView>
            ...
            <View style={styles.contentBody}>
                {/* <View style={styles.middle}>
                    ...
                    <TextInput style={styles.text_input} placeholderTextColor="#000" onChangeText={text=>
                        ...
                        <TextInput style={styles.text_input} placeholderTextColor="#000" onChangeText={text=>
                            ...
                            <TextInput style={styles.text_input} placeholderTextColor="#000" onChangeText={text=>
                                this.setState({ trailer_type: text })}/>
                                <Text style={styles.middle_text}>Commodity</Text>
                                <TextInput style={styles.text_input} placeholderTextColor="#000" onChangeText={text=>
                                    this.setState({ commodity: text })}/>
                                    <TouchableOpacity>
